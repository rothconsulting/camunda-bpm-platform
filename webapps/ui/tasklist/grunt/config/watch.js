module.exports = function(config, watchConf) {
  ...
  watchConf.tasklist_assets = {
    ...
    tasks: ['copy:tasklist_assets', 'copy:tasklist_index']
  };
  ...
  watchConf.tasklist_plugin_styles = {
    ...
    tasks: ['less:tasklist_plugin_styles']
  };
  ...
  watchConf.tasklist_config = {
    ...
    tasks: ['copy:tasklist_config']
  };

  watchConf.tasklist_dependencies = {
    options: options,
    files: ['ui/tasklist/client/en.json'],
    tasks: ['localescompile:tasklist_locales']
  };

  watchConf.tasklist_scripts_lint = {
    options: options,
    files: ['<%= pkg.gruntConfig.tasklistSourceDir %>/scripts/**/*.js'],
    tasks: ['newer:eslint:tasklist_scripts']
  };

  watchConf.tasklist_plugins_lint = {
    options: options,
    files: ['<%= pkg.gruntConfig.pluginSourceDir %>/tasklist/plugins/**/*.js'],
    tasks: ['newer:eslint:tasklist_plugins']
  };
